import type { AvatarControllerHandle, AvatarState } from "./chat-avatar";

type StateListener = (state: AvatarState) => void;
type LipSyncListener = (mouthOpen: number) => void;

export class AvatarController implements AvatarControllerHandle {
...
export function createAvatarController(): AvatarController {
